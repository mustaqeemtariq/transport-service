  ...
  return (
    ...
    >
      ...
      <div className="w-[107px] h-14 relative antialiased">
        <div className="text-white font-stroke font-circular-book text-[56px] font-bold leading-[56px]">
          {price}
        </div>
        <div className="text-white font-circular-book text-[19px] leading-[18px] absolute top-0 -left-3">
          $
        </div>
      </div>

      <div className="w-[266px] text-center text-white text-sm leading-[21px]">
